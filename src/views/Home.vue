<template>
  <div class="home">
    ...
    <div v-for="pixel in pixels" class="pixel_row" v-if="show">
      <div v-for="p in pixel" class="pixel" v-bind:style="{backgroundColor: 'rgb(' + p +')'}">
        <!--rgb:{{p}}-->
      </div>
    </div>
    ...
    <div v-for="pixel in quantization" class="pixel_row">
      <div class="pixel" v-bind:style="{backgroundColor: 'rgb(' + pixel +')'}">
        rgb:{{pixel}}
      </div>
    </div>
  </div>
...
<script>
  ...
  export default {
    ...
    data: function() {
      return {
        pixels: [
          [[202,118,148], [237,141,151], [250,172,164], [239,166,169]],
          [[122,36,41], [175,53,18], [228,43,118], [233,134,60]],
          [[70,49,62], [86,49,35], [150,39,43], [169,56,58]],
          [[151,132, 233], [169,135,244], [179,135,244], [174,139,244]]
        ],
        // quantization: [
        //   [70,70,70],
        //   [120,120,120],
        ...
        // ],
        quantization: [
          [168, 135, 241], [242, 159, 161], [221, 98, 108], [128, 47, 42]
        ],
        middle: [[],[],[],[]],
    ...
    methods: {
      ...
      getTheMiddle(arr) {
        ...
        let new_quantization_level_one = [a/arr.length,b/arr.length,c/arr.length];
